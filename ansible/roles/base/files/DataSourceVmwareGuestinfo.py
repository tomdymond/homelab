...
class DataSourceVmwareGuestinfo(DS):
    ...
    def get_data(self):
        ...
        try:
            ...
            try:
                self.userdata_encoding = self._guestinfo("cloudinit.userdata.encoding")
            except:
                self.userdata_encoding = None

            if "base64" in self.userdata_encoding and self.userdata_raw and self.userdata_raw is not None:
                self.userdata_raw = base64.b64decode(self.userdata_raw)
